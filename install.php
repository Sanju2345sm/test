...
<html>
<head>
	<title>Gamez v1.0 Install Wizard</title>
				...
				<div class="row" style="margin-top:10px;margin-bottom:10px;">
					<div class="col-md-12">
						<nav class="navbar navbar-expand-lg navbar-light bg-light">
							<a class="navbar-brand" href="./install.php">Gamez v1.0 Install Wizard</a>
						</nav>
						<br>
					</div>
					<div class="col-md-4">
								...
								?>
									...
									<form action="" method="POST">
										<div class="form-group">
											<label>Title</label>
											<input type="text" class="form-control" placeholder="Gamez" name="title" value="<?php if(isset($_POST['title'])) { echo $_POST['title']; } ?>">
										</div>
										<div class="form-group">
											<label>Description</label>
											<textarea class="form-control" placeholder="Gamez" name="description" rows="2"><?php if(isset($_POST['description'])) { echo $_POST['description']; } ?></textarea>
										</div>
										<div class="form-group">
											<label>Keywords</label>
											<textarea class="form-control" placeholder="Gamez" name="keywords" rows="2"><?php if(isset($_POST['keywords'])) { echo $_POST['keywords']; } ?></textarea>
										</div>
										<div class="form-group">
											<label>Site name</label>
											<input type="text" class="form-control" placeholder="Gamez" name="name" value="<?php if(isset($_POST['name'])) { echo $_POST['name']; } ?>">
										</div>
										<div class="form-group">
...
';
									...
									@unlink("./database.sql");
									?>
									<h4><i class="fa fa-check"></i> Gamez v1.0 was installed!</h4>
									<p>Your Gamez url address: <a href="<?php echo $url; ?>"><?php echo $url; ?></a></p>
									<p>Your Gamez admin url address: <a href="<?php echo $url; ?>admin"><?php echo $url; ?>admin</a></p>
